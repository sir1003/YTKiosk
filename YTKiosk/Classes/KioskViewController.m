...
// JS tiêm vào mỗi lần trang tải:
// 1. Chặn quảng cáo (overlay, skip button, tua nhanh)
// 2. Ép chất lượng video về 360p (medium) để chip A5 decode mượt mà, không giật lag
// 3. Triệt tiêu hiệu ứng CSS nặng (box-shadow, text-shadow, blur, animation) giúp cuộn mượt và tiết kiệm RAM
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    [webView stringByEvaluatingJavaScriptFromString:AdBlockAndPerfScript()];
}
